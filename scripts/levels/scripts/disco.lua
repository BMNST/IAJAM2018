...
return function()
    ...
    scripts.objects.movingBlock(5, 5, "moveUp", "moveLeft", "moveDown", "moveRight", nil)
    scripts.objects.movingBlock(6, 5, "moveUp", "moveLeft", "moveDown", "moveRight", nil)
    scripts.objects.movingBlock(5, 6, "moveUp", "moveLeft", "moveDown", "moveRight", nil)
    scripts.objects.movingBlock(6, 6, "moveUp", "moveLeft", "moveDown", "moveRight", nil)
end